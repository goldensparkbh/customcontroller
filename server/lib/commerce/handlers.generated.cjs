...
/* eslint-disable max-len -- generated bundle */

const { FieldValue } = require("./fieldValue.cjs");

let __EZ_COMMERCE_DB__ = null;
function injectCommerceDb(db) {
  __EZ_COMMERCE_DB__ = db;
}
function getFirestore() {
  if (!__EZ_COMMERCE_DB__) throw new Error("injectCommerceDb() not called before commerce handlers run");
  return __EZ_COMMERCE_DB__;
}
...
async function zohoProxy(req, res) {
...
async function tapPaymentHandler(req, res) {
res.set("Access-Control-Allow-Origin", "*");
...
exports.tapPaymentHandler = tapPaymentHandler;


async function tapVerificationHandler(req, res) {
res.set("Access-Control-Allow-Origin", "*");
res.set("Access-Control-Allow-Methods", "GET,POST,OPTIONS");
res.set("Access-Control-Allow-Headers", "Content-Type, Authorization");
...
exports.tapVerificationHandler = tapVerificationHandler;

exports.maybeSendBaseControllerLowStockAlert = maybeSendBaseControllerLowStockAlert;
