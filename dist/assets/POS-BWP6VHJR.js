...
`;function i(){return e.useEffect(()=>{const t=document.createElement("script");return t.textContent=n,document.body.appendChild(t),()=>{document.body.contains(t)&&document.body.removeChild(t)}},[]),a.jsx("div",{dangerouslySetInnerHTML:{__html:s}})}export{i as default};
