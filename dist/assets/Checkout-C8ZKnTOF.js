...
`;function r(){return a.useEffect(()=>{const e=document.createElement("script");return e.textContent=i,document.body.appendChild(e),()=>{document.body.contains(e)&&document.body.removeChild(e)}},[]),t.jsx("div",{className:"checkout-page",children:t.jsx("div",{dangerouslySetInnerHTML:{__html:n}})})}export{r as default};
