import{r as s,j as c,L as p,i as l,f as v}from"./index-DOFuCrMe.js";import{b as g}from"./inventoryPricing-CXTXwyZ6.js";const b=`
...
`,m=()=>{const[e,u]=s.useState(!0);if(s.useEffect(()=>{(async()=>{window.__CONFIG_DATA__={i18n:l,baseControllerPrice:0},window.__CONFIG_FIREBASE_DATA__=window.__CONFIG_FIREBASE_DATA__||[];try{const a=await v(),d=(a.parts||[]).map(r=>({...r,options:(r.options||[]).map(n=>{const t=n;return{id:t.id,...t,...g(t.inventoryDetails,{purchasePrice:t.purchasePrice??0,sellPrice:t.sellPrice??t.price??0},{quantity:t.quantity??0})}}).filter(n=>n.active!==!1)})),o=Number(a.basePrice)||0;window.__CONFIG_FIREBASE_DATA__=d,window.__CONFIG_DATA__={i18n:l,baseControllerPrice:o}}catch(a){console.error("Configurator catalog fetch error:",a),window.__CONFIG_FIREBASE_DATA__=[]}finally{u(!1)}})()},[]),s.useEffect(()=>{if(e)return;document.body.classList.add("configurator-page-active");const i=window.requestAnimationFrame(()=>{document.body.classList.add("configurator-intro-active")}),a=window.setTimeout(()=>{document.body.classList.remove("configurator-intro-active")},1350);if(!document.getElementById("ez-configurator-logic-script")){const o=document.createElement("script");o.id="ez-configurator-logic-script",o.src="/configurator-logic.js?v="+Date.now(),o.async=!0,document.body.appendChild(o)}return()=>{if(typeof window.__EZ_CONFIGURATOR_CLEANUP__=="function")try{window.__EZ_CONFIGURATOR_CLEANUP__()}catch(r){console.warn("Configurator cleanup failed",r)}document.body.classList.remove("configurator-page-active"),document.body.classList.remove("configurator-intro-active"),window.cancelAnimationFrame(i),window.clearTimeout(a);const o=document.getElementById("ez-configurator-logic-script");o&&document.body.contains(o)&&document.body.removeChild(o)}},[e]),e){const i=localStorage.getItem("ez_lang")||"ar";return c.jsx(p,{message:l[i]&&l[i].loadingConfigurator||"Loading configurator...",fullScreen:!0})}return c.jsx("div",{className:"configurator-page",children:c.jsx("div",{dangerouslySetInnerHTML:{__html:b}})})};export{m as default};
