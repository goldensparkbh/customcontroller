import{r as i,i as n,j as l,L as g,f as h}from"./index-DkkDJ83L.js";import{b as A}from"./inventoryPricing-CXTXwyZ6.js";const w=`
...
`,f="ezConfiguratorReady",y=45e3,k=()=>{const[e,b]=i.useState(!1),[r,d]=i.useState(!1);i.useEffect(()=>{(async()=>{window.__CONFIG_DATA__={i18n:n,baseControllerPrice:0},window.__CONFIG_FIREBASE_DATA__=window.__CONFIG_FIREBASE_DATA__||[];try{const t=await h(),s=(t.parts||[]).map(v=>({...v,options:(v.options||[]).map(c=>{const o=c;return{id:o.id,...o,...A(o.inventoryDetails,{purchasePrice:o.purchasePrice??0,sellPrice:o.sellPrice??o.price??0},{quantity:o.quantity??0})}}).filter(c=>c.active!==!1)})),m=Number(t.basePrice)||0;window.__CONFIG_FIREBASE_DATA__=s,window.__CONFIG_DATA__={i18n:n,baseControllerPrice:m}}catch(t){console.error("Configurator catalog fetch error:",t),window.__CONFIG_FIREBASE_DATA__=[]}finally{b(!0)}})()},[]),i.useEffect(()=>{if(!e||r)return;const a=()=>d(!0);window.addEventListener(f,a);const t=window.setTimeout(()=>{console.warn("[Configurator] Logic did not signal ready in time; dismissing loader."),d(!0)},y);return()=>{window.removeEventListener(f,a),window.clearTimeout(t)}},[e,r]),i.useEffect(()=>{if(!r)return;document.body.classList.add("configurator-page-active");const a=window.requestAnimationFrame(()=>{document.body.classList.add("configurator-intro-active")}),t=window.setTimeout(()=>{document.body.classList.remove("configurator-intro-active")},1350);return()=>{document.body.classList.remove("configurator-page-active"),document.body.classList.remove("configurator-intro-active"),window.cancelAnimationFrame(a),window.clearTimeout(t)}},[r]),i.useEffect(()=>{if(!e)return;if(!document.getElementById("ez-configurator-logic-script")){const t=document.createElement("script");t.id="ez-configurator-logic-script",t.src="/configurator-logic.js?v="+Date.now(),t.async=!0,document.body.appendChild(t)}return()=>{if(typeof window.__EZ_CONFIGURATOR_CLEANUP__=="function")try{window.__EZ_CONFIGURATOR_CLEANUP__()}catch(s){console.warn("Configurator cleanup failed",s)}document.body.classList.remove("configurator-page-active"),document.body.classList.remove("configurator-intro-active");const t=document.getElementById("ez-configurator-logic-script");t&&document.body.contains(t)&&document.body.removeChild(t)}},[e]);const u=localStorage.getItem("ez_lang")||"ar",p=n[u]&&n[u].loadingConfigurator||"Loading configurator...";return e?l.jsxs("div",{className:"configurator-page",style:{position:"relative"},children:[l.jsx("div",{dangerouslySetInnerHTML:{__html:w}}),!r&&l.jsx("div",{style:{position:"fixed",inset:0,zIndex:2147483e3,background:"#0e1117"},children:l.jsx(g,{message:p,fullScreen:!0})})]}):l.jsx(g,{message:p,fullScreen:!0})};export{k as default};
