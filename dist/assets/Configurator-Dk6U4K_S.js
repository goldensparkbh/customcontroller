import{r as n,j as s,L as b,i as c,g as p,c as u,d as v}from"./index-FiMOSVbW.js";import{b as f}from"./inventoryPricing-Jg4kc6rV.js";const h=`
...
`,w=()=>{const[r,g]=n.useState(!0);if(n.useEffect(()=>{(async()=>{try{const e=(await p(u(v,"configurator_parts"))).docs.map(a=>({id:a.id,...a.data()}));for(const a of e){const l=await p(u(v,`configurator_parts/${a.id}/options`));a.options=l.docs.map(d=>{const t=d.data();return{id:d.id,...t,...f(t.inventoryDetails,{purchasePrice:t.purchasePrice??0,sellPrice:t.sellPrice??t.price??0},{quantity:t.quantity??0})}})}window.__CONFIG_FIREBASE_DATA__=e,window.__CONFIG_DATA__={i18n:c}}catch(i){console.error("Firebase fetch error:",i)}finally{g(!1)}})()},[]),n.useEffect(()=>{if(r)return;document.body.classList.add("configurator-page-active");const o=window.requestAnimationFrame(()=>{document.body.classList.add("configurator-intro-active")}),i=window.setTimeout(()=>{document.body.classList.remove("configurator-intro-active")},1350);if(!document.getElementById("ez-configurator-logic-script")){const a=document.createElement("script");a.id="ez-configurator-logic-script",a.src="/configurator-logic.js?v="+Date.now(),a.async=!0,document.body.appendChild(a)}return()=>{if(typeof window.__EZ_CONFIGURATOR_CLEANUP__=="function")try{window.__EZ_CONFIGURATOR_CLEANUP__()}catch(l){console.warn("Configurator cleanup failed",l)}document.body.classList.remove("configurator-page-active"),document.body.classList.remove("configurator-intro-active"),window.cancelAnimationFrame(o),window.clearTimeout(i);const a=document.getElementById("ez-configurator-logic-script");a&&document.body.contains(a)&&document.body.removeChild(a)}},[r]),r){const o=localStorage.getItem("ez_lang")||"ar";return s.jsx(b,{message:c[o]&&c[o].loadingConfigurator||"Loading configurator...",fullScreen:!0})}return s.jsx("div",{className:"configurator-page",children:s.jsx("div",{dangerouslySetInnerHTML:{__html:h}})})};export{w as default};
