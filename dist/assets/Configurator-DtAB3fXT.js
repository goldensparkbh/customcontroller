import{r as n,j as s,L as p,i as c,f as v}from"./index-DA2lfUFq.js";import{b as g}from"./inventoryPricing-CXTXwyZ6.js";const b=`
...
`,m=()=>{const[r,u]=n.useState(!0);if(n.useEffect(()=>{(async()=>{try{const a=await v(),d=(a.parts||[]).map(l=>({...l,options:(l.options||[]).map(e=>{const o=e;return{id:o.id,...o,...g(o.inventoryDetails,{purchasePrice:o.purchasePrice??0,sellPrice:o.sellPrice??o.price??0},{quantity:o.quantity??0})}}).filter(e=>e.active!==!1)})),t=Number(a.basePrice)||0;window.__CONFIG_FIREBASE_DATA__=d,window.__CONFIG_DATA__={i18n:c,baseControllerPrice:t}}catch(a){console.error("Configurator catalog fetch error:",a)}finally{u(!1)}})()},[]),n.useEffect(()=>{if(r)return;document.body.classList.add("configurator-page-active");const i=window.requestAnimationFrame(()=>{document.body.classList.add("configurator-intro-active")}),a=window.setTimeout(()=>{document.body.classList.remove("configurator-intro-active")},1350);if(!document.getElementById("ez-configurator-logic-script")){const t=document.createElement("script");t.id="ez-configurator-logic-script",t.src="/configurator-logic.js?v="+Date.now(),t.async=!0,document.body.appendChild(t)}return()=>{if(typeof window.__EZ_CONFIGURATOR_CLEANUP__=="function")try{window.__EZ_CONFIGURATOR_CLEANUP__()}catch(l){console.warn("Configurator cleanup failed",l)}document.body.classList.remove("configurator-page-active"),document.body.classList.remove("configurator-intro-active"),window.cancelAnimationFrame(i),window.clearTimeout(a);const t=document.getElementById("ez-configurator-logic-script");t&&document.body.contains(t)&&document.body.removeChild(t)}},[r]),r){const i=localStorage.getItem("ez_lang")||"ar";return s.jsx(p,{message:c[i]&&c[i].loadingConfigurator||"Loading configurator...",fullScreen:!0})}return s.jsx("div",{className:"configurator-page",children:s.jsx("div",{dangerouslySetInnerHTML:{__html:b}})})};export{m as default};
