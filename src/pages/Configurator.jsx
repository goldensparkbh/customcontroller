...
function ConfiguratorPage() {
  useEffect(() => {
    ...
    // Set config data for the external script
    window.__CONFIG_DATA__ = {
      i18n: i18n,
      zohoAccessToken: import.meta.env.VITE_ZOHO_ACCESS_TOKEN || "",
      zohoOrgId: import.meta.env.VITE_ZOHO_ORG_ID || ""
    };

    const scriptEl = document.createElement('script');
    scriptEl.src = '/configurator-logic.js?v=' + new Date().getTime();
    scriptEl.async = true;
