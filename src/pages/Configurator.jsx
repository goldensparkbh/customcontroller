...
const ConfiguratorPage = () => {
  ...
  useEffect(() => {
    ...
    // Check if script is already present? Not strictly needed if unmounted correctly
    const existing = document.getElementById('ez-configurator-logic-script');
    if (!existing) {
      const script = document.createElement('script');
      script.id = 'ez-configurator-logic-script';
      script.src = '/configurator-logic.js?v=' + Date.now(); // cache buster to ensure it runs
      script.async = true;
