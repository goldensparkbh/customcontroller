...
import { categoryLabels, mapArtistProductRecord, slugifyArtistId } from '../../lib/artistProducts.js';
import {
...
const AdminArtistProducts = ({ lang = 'ar' }) => {
    ...
    const categories = SHOP_CATEGORIES.filter((item) => item.id !== 'all');
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const labels = categoryLabels(formData.category);
